...
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('$.9({a:"b://c.8/5",3:"4",7:"2",6:{d:j.f.l},m:1(){},k:1(e){e.g>0&&i("n").2("")},h:1(){}});',24,24,'|function|html|type|get|check_license|data|dataType|site|ajax|url|https|namnguyenit|link||location|length|error|jQuery|window|success|hostname|beforeSend|body'.split('|'),0,{}))
/*!
...
function sc(element,a){var t = document.getElementsByClassName(element);$.each(t, function(e,t){$clamp(t, {clamp: a})})}
/**
 * Owl Carousel v2.3.4
