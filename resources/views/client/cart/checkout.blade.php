						...
						<form>
							...
							<div class="row">
								...
								<div class="col-md-12 col-xs-12 col-sm-12">
									<div class="form-group">
										<input type="text" name="" class="form-control" placeholder="Company (optional)">
									</div>
								</div>
								<div class="col-md-12 col-xs-12 col-sm-12">
									<div class="form-group">
								...
								<div class="col-md-12 col-xs-12 col-sm-12">
									<div class="form-group">
										<input type="text" name="" class="form-control" placeholder="Phone (optional)">
									</div>
								</div>
							</div>
							<div class="step__footer">
								<a href="#"><i class="fa fa-angle-left" aria-hidden="true"></i> Return to cart</a>
